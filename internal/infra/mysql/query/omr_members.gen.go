...
func newMember(db *gorm.DB, opts ...gen.DOOption) member {
	...
	_member.GroupID = field.NewString(tableName, "group_id")
...
func (m *member) WithContext(ctx context.Context) IMemberDo { return m.memberDo.WithContext(ctx) }
...
type IMemberDo interface {
	...
	Unscoped() IMemberDo
	Create(values ...*models.Member) error
	CreateInBatches(values []*models.Member, batchSize int) error
	Save(values ...*models.Member) error
	First() (*models.Member, error)
	Take() (*models.Member, error)
	Last() (*models.Member, error)
	Find() ([]*models.Member, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Member, err error)
	FindInBatches(result *[]*models.Member, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Member) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Member, error)
	FirstOrCreate() (*models.Member, error)
	FindByPage(offset int, limit int) (result []*models.Member, count int64, err error)
