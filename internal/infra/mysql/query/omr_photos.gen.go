...
type IPhotoDo interface {
	...
	Unscoped() IPhotoDo
	Create(values ...*models.Photo) error
	CreateInBatches(values []*models.Photo, batchSize int) error
	Save(values ...*models.Photo) error
	First() (*models.Photo, error)
	Take() (*models.Photo, error)
	Last() (*models.Photo, error)
	Find() ([]*models.Photo, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Photo, err error)
	FindInBatches(result *[]*models.Photo, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Photo) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Photo, error)
	FirstOrCreate() (*models.Photo, error)
	FindByPage(offset int, limit int) (result []*models.Photo, count int64, err error)
...
func (p photoDo) Create(values ...*models.Photo) error {
	if len(values) == 0 {
		return nil
	}
...
func (p photoDo) CreateInBatches(values []*models.Photo, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p photoDo) Save(values ...*models.Photo) error {
	if len(values) == 0 {
		return nil
	}
...
func (p photoDo) First() (*models.Photo, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Photo), nil
	}
}

func (p photoDo) Take() (*models.Photo, error) {
...
func (p photoDo) Last() (*models.Photo, error) {
...
func (p photoDo) Find() ([]*models.Photo, error) {
	result, err := p.DO.Find()
	return result.([]*models.Photo), err
}

func (p photoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Photo, err error) {
	buf := make([]*models.Photo, 0, batchSize)
...
func (p photoDo) FindInBatches(result *[]*models.Photo, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p photoDo) FirstOrInit() (*models.Photo, error) {
...
func (p photoDo) FirstOrCreate() (*models.Photo, error) {
...
func (p photoDo) FindByPage(offset int, limit int) (result []*models.Photo, count int64, err error) {
...
func (p photoDo) Delete(models ...*models.Photo) (result gen.ResultInfo, err error) {
