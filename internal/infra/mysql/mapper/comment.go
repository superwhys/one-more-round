...
func CommentModelToDomain(m *models.RoundComment) *diary.Comment {
	...
	return &diary.Comment{ID: m.ID, GroupID: m.GroupID, RoundID: m.RoundID, Author: m.Author, Body: m.Body, ParentID: m.ParentID, Created: m.Created}
}
...
func CommentDomainToModel(c *diary.Comment) *models.RoundComment {
	...
	return &models.RoundComment{ID: c.ID, GroupID: c.GroupID, RoundID: c.RoundID, Author: c.Author, Body: c.Body, ParentID: c.ParentID, Created: c.Created}
}
