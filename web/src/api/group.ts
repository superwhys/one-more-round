...
export const createGroup = (name: string, playerName: string) =>
  send<Group>('/groups', { name, player_name: playerName })
...
export const manageGroup = (id: string, action: GroupAction, target = '', value = '') =>
  send<void>(`/groups/${id}/manage`, { action, target, value })
