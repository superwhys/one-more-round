...
<template>
  <aside class="d-sidebar">
    ...
    <nav class="d-navigation" aria-label="主要导航">
      <RouterLink to="/" :class="{ active: section === 'review' }"><Icon name="review" />回顾</RouterLink
      ><RouterLink to="/games" :class="{ active: section === 'games' }"><Icon name="game" />桌游</RouterLink
      ><RouterLink to="/group" :class="{ active: section === 'group' }"><Icon name="group" />小组</RouterLink>
    </nav>
  ...
  <nav v-if="!editor" class="d-mobile-nav" aria-label="手机导航">
    <RouterLink to="/"><Icon name="review" />回顾</RouterLink
    ><RouterLink to="/games"><Icon name="game" />桌游</RouterLink
    ><RouterLink to="/group"><Icon name="group" />小组</RouterLink>
  </nav>
</template>
